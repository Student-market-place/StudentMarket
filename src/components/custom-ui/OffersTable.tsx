          ...
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-lg font-semibold">
                Offres correspondant aux compétences de vos étudiants
              </h3>
              <p className="text-sm text-muted-foreground">
                {offers.length} offres correspondent aux compétences principales
                de vos étudiants
              </p>
            </div>
              ...
              <TableBody>
                {offers.length === 0 ? (
                  <TableRow>
                    ...
                    >
                      Aucune offre trouvée correspondant aux compétences de vos
                      étudiants
                    </TableCell>
                  </TableRow>
                ) : (
